...
public class Quran extends Asset {

	public Quran(String author, String publisher, String genre, String publication_time, int page_count) {
		super(author, publisher, genre, publication_time, page_count);

	}

	private boolean Allah;

	public boolean getAllah() {
		return Allah;
	}

	public void setAllah(boolean allah) {
		Allah = allah;
	}
